...
export const buildStudentAiInsight = ({
  ...
  const strengths = examCount === 0
    ? [
        ...
        "Оноо болон түвшний мэдээлэл чинь энэ хэсгийн зөвлөмжийг улам оновчтой болгоно.",
      ]
    : [
        strongestSubject
        ...
        currentRank && totalStudents > 0
          ? `Ерөнхий онооны эрэмбэд #${currentRank}/${totalStudents} явж байгаа нь хичээлдээ тогтмол оролцож байгааг илтгэнэ.`
          : `${levelInfo.name} түвшинд хүрсэн нь хуримтлуулсан оноо тогтвортой өсөж байгааг харуулж байна.`,
      ];
