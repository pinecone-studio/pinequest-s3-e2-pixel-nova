...
const mockHistory = [
  { title: "Алгебрын тест", score: "88%", date: "2026-03-20" },
  { title: "Түүхийн шалгалт", score: "72%", date: "2026-03-12" },
  { title: "Химийн лаборатори", score: "95%", date: "2026-02-28" },
];
                      ...
                      <>
                        ...
                        <div className={mutedCardClass}>
                          ...
                          <div className="mt-2 text-xs text-muted-foreground">
                            ...
                            {Math.max(nextLevel.minXP - studentProgress.xp, 0)}{" "}
                            XP
                          </div>
                        </div>
                        <div className={mutedCardClass}>
              ...
              {activeTab === "Дүн" && (
                <section className="grid gap-4 lg:grid-cols-[1.2fr_1fr]">
                  ...
                  <p className="mt-3 text-sm text-muted-foreground">
                    Ерөнхий гүйцэтгэл сайн байна. Хугацаагаа зөв хуваарилж, олон
                    алхамтай бодлогод тооцоогоо дахин нягтлаарай.
                  </p>
                    <div className="mt-4 rounded-xl border border-border bg-muted px-3 py-2 text-xs">
                    Дундаж дүн: 85%
                    </div>
                ...
                <section className="grid gap-4 lg:grid-cols-2">
                  <div className={cardClass}>
                    ...
                    <div className="mt-4 space-y-2 text-sm text-muted-foreground">
                      <div>Нэр: {currentUser.username}</div>
        ...
        <div className="min-h-screen bg-background px-6 py-8 text-foreground">
          ...
          <header className="mx-auto flex w-full max-w-5xl flex-wrap items-center justify-between gap-3 rounded-2xl border border-border bg-card px-4 py-3 shadow-sm">
            ...
            <div className="text-sm text-muted-foreground">
              {currentQuestionIndex + 1}/
              {activeExam ? activeExam.questions.length || 1 : 1}
            </div>
          ...
          <div className="mx-auto mt-6 grid w-full max-w-5xl gap-4 lg:grid-cols-[1fr_140px]">
            <div className="rounded-2xl border border-border bg-card p-6 shadow-sm">
              ...
              {activeExam?.questions[currentQuestionIndex]?.type === "open" ? (
                ...
                />
              ) : activeExam?.questions[currentQuestionIndex]?.type ===
                "mcq" ? (
                <div className="mt-4 grid gap-3 sm:grid-cols-2">
                  {(
                    ...
                    const currentAnswer =
                      ...
                      "";
                    const isSelected =
                      currentAnswer === option || currentAnswer === label;
                    return (
                      <button
                        key={`${label}-${option}`}
