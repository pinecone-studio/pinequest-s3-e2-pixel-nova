...
export default function TeacherEmptyState({
  ...
  return (
    <div className="rounded-[28px] border border-dashed border-[#d8e3f0] bg-[linear-gradient(180deg,#fbfdff_0%,#f6f9fe_100%)] px-6 py-10 text-center shadow-[0_18px_34px_-34px_rgba(15,23,42,0.22)]">
