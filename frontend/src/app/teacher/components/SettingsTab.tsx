...
export default function SettingsTab({
  ...
  if (!activeExam) {
    return (
      <section className="rounded-[30px] border border-dashed border-border bg-card px-6 py-10 text-center shadow-sm">
  ...
  return (
    <section className="space-y-6">
      <div className="flex flex-wrap items-start justify-between gap-4">
        ...
        <div className="flex items-center gap-3 rounded-full bg-card px-4 py-2 shadow-sm ring-1 ring-border">
      ...
      <div className="space-y-5">
        {questions.map((question) => (
          <article
            key={question.id}
            className="rounded-[30px] border border-border bg-card px-5 py-5 shadow-sm"
          >
