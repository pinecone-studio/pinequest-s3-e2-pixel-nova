...
describe("AnalyticsTab chart helpers", () => {
	it("shows the latest 11 months ending with the current month", () => {
		...
		expect(chartData).toEqual([
			...
			{ name: "11 сар", "дундаж": undefined, "тэнцсэн": undefined },
			...
			{ name: "3 сар", "дундаж": undefined, "тэнцсэн": undefined },
